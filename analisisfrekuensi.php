...
<head>
  ...
  <script src="/controller/normInv.js"></script>
        ...
        <nav class="navbar fixed-top navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Logo Website -->
            ...
            <a class="navbar-brand" href="/">
              <img src="/img/g.png" width="23" height="23" alt="Analisis Frekuensi Curah Hujan">
            </a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm">
                ...
                <p class="mb-4">Perhitungan Analisis Frekuensi Curah Hujan</a>.</p>
                </div>
              </div>
            </div>

          <!-- DataTales Example -->
                    <?php include('controller/hitung1.php')?>
                    <div></div>
                    <?php include('controller/hitung2.php')?>
                    <div></div>
                    <?php include('controller/ch.php')?>
